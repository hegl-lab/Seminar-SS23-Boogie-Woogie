...
class Canvas extends Cell {
  ...
  minX(y) {
    if (y < this.yCtr()) return this.xMin + (this.yCtr() - y);
    else return this.xMin + (y - this.yCtr());
  }
  maxX(y) {
    if (y < this.yCtr()) return this.xMax - (this.yCtr() - y);
    else return this.xMax - (y - this.yCtr());
  }
  minY(x) {
    if (x < this.xCtr()) return this.yMin + (this.xCtr() - x);
    else return this.yMin + (x - this.xCtr());
  }
  maxY(x) {
    if (x < this.xCtr()) return this.yMax - (this.xCtr() - x);
    else return this.xMax - (x - this.xCtr());
  }
